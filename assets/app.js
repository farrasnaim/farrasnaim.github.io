...
(function () {
    ...
    var RIG = [
        ...
        { part: 'cam', label: 'webcam', label_id: 'webcam', name: 'Streamplify CAM PRO', spec: '4K · fixed on the bezel',
          why: 'a camera people keep telling me looks good — on streams and on calls alike. I did not buy it to look cinematic; <strong>it turns out having a webcam that does not make your face look like a victim of 2020 Zoom is worth it.</strong>',
    ...
    var TRIPS = [
        ...
        { city: 'Cairo', country: 'Egypt', lat: 30.04, lon: 31.24, when: 'apr 2025',
          note: 'the longest single leg I have flown — over eleven hours one way. we stopped here to see the Pyramids before continuing to Saudi Arabia for Umrah. standing in front of them is still one of the closest moments I have had to "I cannot believe this is real" — honestly, it is not just Egypt; it is the realisation that a place you have only seen in photos actually exists in physical form, that huge.',
          note_id: 'rute tunggal terpanjang yang pernah gua terbangin — sebelas jam lebih sekali jalan. kita mampir ke sini buat liat The Pyramids sebelum lanjut ke Arab Saudi buat Umrah. berdiri di depannya masih jadi salah satu momen paling dekat dengan rasa "nggak mungkin ini beneran ada" — jujur ini bukan cuma soal Mesirnya, tapi soal realisasi pas tempat yang selama ini cuma lo liat di foto ternyata beneran ada wujud fisiknya segede itu.',
